    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper">
          ...
          <img v-show="user.profileImageUrl" :src="user.profileImageUrl" class="user-avatar">
          <img v-show="!user.profileImageUrl" src="@/assets/images/logo.png" class="user-avatar">
